            ...
            children: <Widget>[
              Column(
                children: <Widget>[
                  Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage("assets/image/dokter.png")
                      )
                    ),
                  ),
                  RichText(
                  ...
                  Text("Banyaknya pilihan spesialis, pilihan rumah sakit, dan pilihan dokter dapat membuatmu dengan mudah menemukan dokter spesialis yang sesuai keinginan. ",
                  textAlign: TextAlign.center,
                  style: TextStyle(
